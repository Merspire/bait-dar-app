    ...
    <div className={`min-h-screen bg-background ${isRTL ? 'font-arabic' : 'font-english'}`} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <div className="max-w-4xl mx-auto space-y-6">
            <Badge variant="secondary" className="bg-white/20 text-white border-white/30 mb-4">
              {getText('أكثر من 440,000 عقار متاح', '440,000+ Properties Available')}
            </Badge>
      ...
      <section className="py-8 -mt-16 relative z-20">
        <div className="container mx-auto px-4">
          <SearchFilters language={currentLanguage.code as 'ar' | 'en'} onSearch={handleSearch} />
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 opacity-90">
                ...
                <li><a href="#" className="hover:opacity-100 transition-smooth">{getText('المدونة', 'Blog')}</a></li>
              </ul>
            </div>
