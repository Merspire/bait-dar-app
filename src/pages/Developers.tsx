      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl">
            {getText(
              "اكتشف أفضل المطورين والشركات العقارية في مصر",
              "Discover the best developers and real estate companies in Egypt"
            )}
          </p>
        </div>
      ...
      <footer className="bg-primary text-primary-foreground py-16 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 opacity-90">
                <li>
                  <Link to="/" className="hover:opacity-100 transition-smooth">
                    {getText("الرئيسية", "Home")}
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center opacity-90">
            <p>
              &copy; 2024 {getText("عقار لينك", "Aqar Link")}.{" "}
