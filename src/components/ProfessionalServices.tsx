...
const services = [
  {
    ...
    descriptionEn:
      "Join over 7,500 companies, become our partner and connect with more clients",
    action: "انضم الآن",
    actionEn: "Join Now",
    highlight: true,
  ...
  },
  {
    ...
    descriptionEn:
      "Get advanced reports and analysis of the real estate market",
    action: "تصفح الأبحاث",
  ...
  },
  {
    ...
    title: "العروض",
    titleEn: "Offers",
    description: "عروض من المطورين والوسطاء وأصحاب العقارات للعقارات المتاحة",
    descriptionEn: "Offers from developers, agents and property owners",
    action: "شاهد العروض",
    actionEn: "View Offers",
    highlight: false,
          ...
          {services.map((service, index) => (
            <Card
              ...
              className={`overflow-hidden transition-smooth hover:shadow-elegant group ${
                service.highlight
                  ? "ring-2 ring-primary/20 bg-gradient-card"
                  : ""
              }`}
            >
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  className={`w-full transition-smooth hover:scale-105 ${
                    service.highlight ? "bg-primary hover:bg-primary/90" : ""
                  }`}
